...
###############################################################################
#   Train vanilla DETM on COHA corpus only with MERGED vocabulary
...
# Use merged vocabulary with 5-year rebinned timestamps (COHA only)
# NOTE: You must run rebin_individual_merged_vocab.sh first!
DATA_DIR="$PROJECT_ROOT/data_processing_scripts/individual_corpora_min100_5year_v3/coha"
EMB_PATH="$DATA_DIR/min_df_${MIN_DF}/embedding.npy"

TIMESTAMP=$(date +'%Y%m%d_%H%M%S')
SAVE_ROOT="$PROJECT_ROOT/detm_individual_merged_5year_v3/coha_topic${NUM_TOPICS}_min_df${MIN_DF}_delta${DELTA}_${TIMESTAMP}"
...
echo "============================================"
echo "Training COHA DETM with merged vocab (5-year bins)"
echo "============================================"
...
echo ""
echo "============================================"
echo "Training completed for COHA (merged vocab, 5-year bins)"
