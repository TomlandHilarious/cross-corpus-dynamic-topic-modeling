...
###############################################################################
#   Train vanilla DETM on ILR corpus only with ILR-specific vocabulary
...
DATA_DIR="$PROJECT_ROOT/data_processing_scripts/individual_corpora_specific_vocab_5year_v3/ilr"
EMB_PATH="$DATA_DIR/min_df_${MIN_DF}/embedding.npy"

TIMESTAMP=$(date +'%Y%m%d_%H%M%S')
SAVE_ROOT="$PROJECT_ROOT/detm_individual_specific_vocab_5year_v3/ilr_topic${NUM_TOPICS}_min_df${MIN_DF}_delta${DELTA}_${TIMESTAMP}"
...
echo "============================================"
echo "Training ILR DETM with corpus-specific vocab (5-year bins)"
echo "============================================"
...
echo ""
echo "============================================"
echo "Training completed for ILR (specific vocab, 5-year bins)"
