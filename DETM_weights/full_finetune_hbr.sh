...
###############################################################################
#   Full Fine-tuning Baseline: HBR
#   Start from merged backbone, unfreeze ALL parameters, train on HBR only
...
# ---------- Merged data (same vocab as backbone, filter to HBR docs) ----------
...
SOURCE_FILTER="HBR"  # Filter to only HBR documents
...
SAVE_ROOT="$PROJECT_ROOT/detm_full_finetune_baseline/hbr_fullft_topic${NUM_TOPICS}_${TIMESTAMP}"
...
echo "============================================"
echo "Full Fine-tuning Baseline: HBR"
echo "============================================"
