...
###############################################################################
#   Full Fine-tuning Baseline: COHA
#   Start from merged backbone, unfreeze ALL parameters, train on COHA only
...
# ---------- Merged data (same vocab as backbone, filter to COHA docs) ----------
...
SAVE_ROOT="$PROJECT_ROOT/detm_full_finetune_baseline/coha_fullft_topic${NUM_TOPICS}_${TIMESTAMP}"
...
echo "============================================"
echo "Full Fine-tuning Baseline: COHA"
echo "============================================"
