...
###############################################################################
#   Train vanilla DETM on merged (all corpora combined) dataset
...
# Use merged vocabulary with 5-year rebinned timestamps (all corpora combined)
...
SAVE_ROOT="$PROJECT_ROOT/detm_merged_5year/merged_topic${NUM_TOPICS}_min_df${MIN_DF}_delta${DELTA}_${TIMESTAMP}"
...
echo "============================================"
echo "Training MERGED DETM (all corpora combined, 5-year bins)"
echo "============================================"
...
echo ""
echo "============================================"
echo "Training completed for MERGED (all corpora, 5-year bins)"
