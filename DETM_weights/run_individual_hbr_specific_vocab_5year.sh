...
###############################################################################
#   Train vanilla DETM on HBR corpus only with HBR-specific vocabulary
...
# Use corpus-specific vocabulary with 5-year rebinned timestamps
# NOTE: You must run rebin_timestamps.py on the corpus-specific data first!
DATA_DIR="$PROJECT_ROOT/data_processing_scripts/individual_corpora_specific_vocab_5year_v3/hbr"
EMB_PATH="$DATA_DIR/min_df_${MIN_DF}/embedding.npy"

TIMESTAMP=$(date +'%Y%m%d_%H%M%S')
SAVE_ROOT="$PROJECT_ROOT/detm_individual_specific_vocab_5year_v3/hbr_topic${NUM_TOPICS}_min_df${MIN_DF}_delta${DELTA}_${TIMESTAMP}"
...
echo "============================================"
echo "Training HBR DETM with corpus-specific vocab (5-year bins)"
echo "============================================"
...
echo ""
echo "============================================"
echo "Training completed for HBR (specific vocab, 5-year bins)"
