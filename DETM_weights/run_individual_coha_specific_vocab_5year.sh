...
###############################################################################
#   Train vanilla DETM on COHA corpus only with COHA-specific vocabulary
...
DATA_DIR="$PROJECT_ROOT/data_processing_scripts/individual_corpora_specific_vocab_5year_v3/coha"
EMB_PATH="$DATA_DIR/min_df_${MIN_DF}/embedding.npy"

TIMESTAMP=$(date +'%Y%m%d_%H%M%S')
SAVE_ROOT="$PROJECT_ROOT/detm_individual_specific_vocab_5year_v3/coha_topic${NUM_TOPICS}_min_df${MIN_DF}_delta${DELTA}_${TIMESTAMP}"
...
echo "============================================"
echo "Training COHA DETM with corpus-specific vocab (5-year bins)"
echo "============================================"
...
echo ""
echo "============================================"
echo "Training completed for COHA (specific vocab, 5-year bins)"
